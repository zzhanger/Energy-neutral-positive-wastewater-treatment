...
# 设置左图属性
ax1.set_xlabel('Flow based EUI (kWh/m³)', fontsize=18, fontweight='bold')
ax1.set_ylabel('Density', fontsize=18, fontweight='bold')
...
# 设置右图属性
ax2.set_xlabel('COD removal based EUI (kWh/kg COD removed)', fontsize=18, fontweight='bold')
